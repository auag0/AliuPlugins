...
subprojects {
    ...
    aliucord {
        author("あざらし", 540811752518975508L)
        updateUrl.set("https://raw.githubusercontent.com/auag0/AliuPlugins/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/auag0/AliuPlugins/builds/%s.zip")
    }
